...
$(document).ready(function () {
    ...
    $("#addIngridient").click(function (e) {
        ...
        var newIn = '<div class="row" id="ingridientRow' + next + '"><input class="form-control col-md-11" id="ingridient' + next + '" name="ingridient' + next + '" type="text" placeholder="Ingrediens"></div>';
        var newInput = $(newIn);
